...
Stream your computer screen to Lilka display over WiFi. It's designed to be loaded from KeiraOS and uses Keira's WiFi credentials automatically.
...
**Run from KeiraOS**
1. Download firmware file to SD card
...
Clone repository, navigate to transmitter directory and run:
